...
def get_adopsi_by_id(id_adopter: str, id_hewan: str) -> Optional[Dict[str, Any]]:
    result = supabase.table('adopsi').select('*').eq('id_adopter', id_adopter).eq('id_hewan', id_hewan).execute().data
...
# Update functions
def update_adopsi(id_adopter: str, id_hewan: str, data: Dict[str, Any]) -> Dict[str, Any]:
    return supabase.table('adopsi').update(data).eq('id_adopter', id_adopter).eq('id_hewan', id_hewan).execute().data[0]
...
# Delete functions
def delete_adopsi(id_adopter: str, id_hewan: str) -> Dict[str, Any]:
    return supabase.table('adopsi').delete().eq('id_adopter', id_adopter).eq('id_hewan', id_hewan).execute().data[0]
